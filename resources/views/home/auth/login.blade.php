...
<head>
    <meta charset="utf-8" />
    <link rel="apple-touch-icon" sizes="76x76" href="home/assets/img/logo-x.png">
    <link rel="icon" type="image/png" href="home/assets/img/logo-x.png">
    ...
    <link href="home/assets/css/now-ui-kit.css?v=1.1.0" rel="stylesheet" />
    <!-- CSS Just for demo purpose, don't include it in your project -->
    <link href="home/assets/css/demo.css" rel="stylesheet" />
    <!-- Canonical SEO -->
...
<body class="login-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" data-nav-image="home/assets/img/blurred-image-1.jpg">
                <ul class="navbar-nav">
                    <li class="nav-item">
    ...
    <div class="page-header" filter-color="orange">
        <div class="page-header-image" style="background-image:url(home/assets/img/login.jpg)"></div>
        <div class="container">
                    ...
                    <form class="form" method="" action="">
                        <div class="header header-primary text-center">
                            <div class="logo-container">
                                <img src="home/assets/img/logo-x.png" alt="">
                            </div>
                        </div>
                        <div class="content">
                            <div class="input-group form-group-no-border input-lg">
                                ...
                                <input type="text" class="form-control" placeholder="账户名...">
                            </div>
                            <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                        ...
                        <div class="pull-left">
                            <h6>
                                <a href="#pablo" class="link">创建账户</a>
                            </h6>
                        </div>
                        <div class="pull-right">
                            <h6>
                                <a href="#pablo" class="link">需要帮助吗？</a>
                            </h6>
                        </div>
                    </form>
                </div>
...
<!--   Core JS Files   -->
<script src="home/assets/js/core/jquery.3.2.1.min.js" type="text/javascript"></script>
...
<script src="home/assets/js/plugins/bootstrap-switch.js"></script>
<!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
<script src="home/assets/js/plugins/nouislider.min.js" type="text/javascript"></script>
<!--  Plugin for the DatePicker, full documentation here: https://github.com/uxsolutions/bootstrap-datepicker -->
<script src="home/assets/js/plugins/bootstrap-datepicker.js" type="text/javascript"></script>
<!-- Share Library etc -->
<script src="home/assets/js/plugins/jquery.sharrre.js" type="text/javascript"></script>
<!-- Control Center for Now Ui Kit: parallax effects, scripts for the example pages etc -->
<script src="home/assets/js/now-ui-kit.js?v=1.1.0" type="text/javascript"></script>
