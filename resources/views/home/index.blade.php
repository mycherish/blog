...
<head>
    ...
    <link rel="shortcut icon" href="home/assets/img/ico/yinanwd.ico">
    <link rel="apple-touch-icon" sizes="144x144" href="home/assets/img/ico/apple-touch-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="114x114" href="home/assets/img/ico/apple-touch-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="72x72" href="home/assets/img/ico/apple-touch-icon-72x72.png">
    <link rel="apple-touch-icon" href="home/assets/img/ico/apple-touch-icon-57x57.png">
    ...
    <link href="home/assets/css/plugins.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="home/assets/css/style.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="home/assets/font-awesome-4.1.0/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link href="home/assets/css/pe-icons.css" rel="stylesheet">
    ...
    <div class="master-wrapper">
        ...
        <div class="preloader">
            <div class="preloader-img">
            	<span class="loading-animation animate-flicker"><img src="home/assets/img/loading.GIF" /></span>
            </div>
        </div>
        ...
        <nav class="navbar navbar-default navbar-fixed-top fadeInDown" data-wow-delay="0.5s">
            <div class="container-fluid">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand smoothie" href="/">GRACE</a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="main-navigation">
                    <ul class="nav navbar-nav navbar-right">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown">首页 <span class="pe-7s-angle-down"></span></a>
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="/">Home Fullscreen Slider</a></li>
        ...
        <header id="headerwrap" class="backstretched fullheight">
            <div class="container vertical-center">
                <div class="intro-text vertical-center text-center smoothie">
                    ...
                    <div class="intro-heading wow fadeIn heading-font" data-wow-delay="0.4s">We Are <span class="rotate">Grace, Power, Style</span></div>
            ...
            <div class="section-inner">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center mb100 wow fadeIn" data-wow-delay="0.5s">                        
                            <h2 class="section-heading">Welcome To Grace</h2>
                            <hr class="thin-hr">
                ...
                <div>
                    <div class="container">
                        ...
                        <div class="col-md-6">
                            <img src="home/assets/img/isometric-ipad-white.png" class="img-responsive alignright wow fadeInRight" data-wow-delay="0.5s" alt="">
                        </div>
                    </div>
                </div>
        ...
        <div class="col-sm-6 nopadding-lr dark-wrapper opaqued background-cover" style="background-image: url('home/assets/img/bg/bg1.jpg');">
        ...
        <div class="col-sm-6 nopadding-lr dark-wrapper opaqued background-cover" style="background-image: url('home/assets/img/bg/bg3.jpg');">
        ...
        <section class="dark-wrapper opaqued parallax" data-parallax="scroll" data-image-src="home/assets/img/bg/bg6.jpg" data-speed="0.7">
            <div class="section-inner">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center mb100 wow fadeIn" data-wow-delay="0.5s">
                            ...
                            <ul class="owl-carousel-paged testimonial-owl wow fadeIn list-unstyled" data-items="1" data-items-tablet="[768,1]" data-items-mobile="[479,1]">
                                <li>
                                    <div class="row">
                                        <div class="col-xs-10 col-xs-offset-1 item-caption text-center">
                                            <div class="mb30">
                                                <img src="home/assets/img/team/small1.jpg" class="img-responsive img-circle testimonial-author" alt="">
                                            </div>
                                ...
                                <li>
                                    <div class="row">
                                        <div class="col-xs-10 col-xs-offset-1 item-caption text-center">
                                            <div class="mb30">
                                                <img src="home/assets/img/team/small2.jpg" class="img-responsive img-circle testimonial-author" alt="">
                                            </div>
                                            <p class="lead">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sunt ut voluptatum eius sapiente</p>
                                            <h4>Charles Davies</h4>
                                        </div>
        ...
        <section>
            <div class="section-inner nopaddingbottom">
                ...
                <div class="wow fadeIn" data-wow-delay="0.5s">
                     <ul class="portfolio-filter mb30 text-center list-inline wow fadeIn" data-wow-delay="0.5s" alt="">
                    ...
                    <ul class="portfolio-items nopadding-lr isotope list-unstyled">
                        <li class="col-md-4 portfolio-item nopadding-lr apps isotope-item hover-item">
                            <img src="home/assets/img/portfolio/portfolio1.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                            <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                                <h3 class="vertical-center smoothie"><a href="single-portfolio-fullscreen.html" title="view project">Fullscreen Gallery</a></h3>
                            </div>
                            <div class="hover-item-caption smoothie">
                                <div class="vertical-center smoothie">
                                    <a href="home/assets/img/portfolio/portfolio1.jpg" title="view Gallery" class="btn btn-primary btn-white page-scroll lb-link smoothie">Zoom</a>
                                    <a href="single-portfolio-fullscreen.html" class="smoothie btn btn-primary btn-white page-scroll">View</a>
                                </div>
                            </div>
                        </li>
                        <li class="col-md-4 portfolio-item nopadding-lr design isotope-item hover-item">
                            <img src="home/assets/img/portfolio/portfolio2.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                            <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                                <h3 class="vertical-center smoothie"><a href="single-portfolio-fullscreen-video.html" title="view project">Fullscreen Video</a></h3>
                            </div>
                            <div class="hover-item-caption smoothie">
                                <div class="vertical-center smoothie">
                                    <a href="home/assets/img/portfolio/portfolio1.jpg" title="view Gallery" class="btn btn-primary btn-white page-scroll lb-link smoothie">Zoom</a>
                                    <a href="single-portfolio-fullscreen-video.html" class="smoothie btn btn-primary btn-white page-scroll">View</a>
                                </div>
                            </div>
                        </li>
                        <li class="col-md-4 portfolio-item nopadding-lr photography isotope-item hover-item">
                            <img src="home/assets/img/portfolio/portfolio3.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                            <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                                <h3 class="vertical-center smoothie"><a href="single-portfolio.html" title="view project">Slider Gallery</a></h3>
                            </div>
                            <div class="hover-item-caption smoothie">
                                <div class="vertical-center smoothie">
                                    <a href="home/assets/img/portfolio/portfolio1.jpg" title="view Gallery" class="btn btn-primary btn-white page-scroll lb-link smoothie">Zoom</a>
                        ...
                        <li class="col-md-4 portfolio-item nopadding-lr video isotope-item hover-item">
                            <img src="home/assets/img/portfolio/portfolio4.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                            <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                                <h3 class="vertical-center smoothie"><a href="single-portfolio-carousel.html" title="view project">Carousel Gallery</a></h3>
                            </div>
                            <div class="hover-item-caption smoothie">
                                <div class="vertical-center smoothie">
                                    <a href="home/assets/img/portfolio/portfolio1.jpg" title="view Gallery" class="btn btn-primary btn-white page-scroll lb-link smoothie">Zoom</a>
                                    <a href="single-portfolio-carousel.html" class="smoothie btn btn-primary btn-white page-scroll">View</a>
                                </div>
                            </div>
                        </li>
                        <li class="col-md-4 portfolio-item nopadding-lr design isotope-item hover-item">
                            <img src="home/assets/img/portfolio/portfolio5.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                            <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                                <h3 class="vertical-center smoothie"><a href="single-portfolio-video.html" title="view project">Video</a></h3>
                            </div>
                            <div class="hover-item-caption smoothie">
                                <div class="vertical-center smoothie">
                                    <a href="home/assets/img/portfolio/portfolio1.jpg" title="view Gallery" class="btn btn-primary btn-white page-scroll lb-link smoothie">Zoom</a>
                                    <a href="single-portfolio-video.html" class="smoothie btn btn-primary btn-white page-scroll">View</a>
                                </div>
                            </div>
                        </li>
                        <li class="col-md-4 portfolio-item nopadding-lr photography isotope-item hover-item">
                            <img src="home/assets/img/portfolio/portfolio6.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                            <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                        ...
                        <li class="col-md-4 portfolio-item nopadding-lr video isotope-item hover-item">
                            <img src="home/assets/img/portfolio/portfolio7.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                            <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                                <h3 class="vertical-center smoothie"><a href="single-portfolio.html" title="view project">Project Title</a></h3>
                            </div>
                            <div class="hover-item-caption smoothie">
                        ...
                        <li class="col-md-4 portfolio-item nopadding-lr design isotope-item hover-item">
                            <img src="home/assets/img/portfolio/portfolio8.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                            <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                                <h3 class="vertical-center smoothie"><a href="single-portfolio.html" title="view project">Project Title</a></h3>
                            </div>
                            <div class="hover-item-caption smoothie">
                        ...
                        <li class="col-md-4 portfolio-item nopadding-lr design isotope-item hover-item">
                            <img src="home/assets/img/portfolio/portfolio9.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                            <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                                <h3 class="vertical-center smoothie"><a href="single-portfolio.html" title="view project">Project Title</a></h3>
                            </div>
                            <div class="hover-item-caption smoothie">
                                ...
                                <ul class="owl-carousel-paged testimonial-owl wow fadeIn list-unstyled" data-items="3" data-items-tablet="[768,2]" data-items-mobile="[479,1]">
                                    <li>
                                        <div class="row hover-item">
                                            <div class="col-xs-12">
                                                <img src="home/assets/img/team/team1.jpg" class="img-responsive smoothie" alt="">
                                            </div>
                                            <div class="col-xs-12 hover-item-caption smoothie">
                                            	<div class="vertical-center">
    					                            ...
    					                            <ul class="smoothie list-inline social-links wow fadeIn" data-wow-delay="0.5s">
    							                        <li>
                                    ...
                                    <li>
                                        <div class="row hover-item">
                                            <div class="col-xs-12">
                                                <img src="home/assets/img/team/2.jpg" class="img-responsive smoothie" alt="">
                                            </div>
                                            <div class="col-xs-12 hover-item-caption smoothie">
                                            	<div class="vertical-center">
                                    ...
                                    <li>
                                        <div class="row hover-item">
                                            <div class="col-xs-12">
                                                <img src="home/assets/img/team/team2.jpg" class="img-responsive smoothie" alt="">
                                            </div>
                                            <div class="col-xs-12 hover-item-caption smoothie">
                                            	<div class="vertical-center">
                                    ...
                                    <li>
                                        <div class="row hover-item">
                                            <div class="col-xs-12">
                                                <img src="home/assets/img/team/4.jpg" class="img-responsive smoothie" alt="">
                                            </div>
                                            <div class="col-xs-12 hover-item-caption smoothie">
                                            	<div class="vertical-center">
        ...
        <section class="dark-wrapper">
            <div class="section-inner nopaddingbottom">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center mb100 wow fadeIn" data-wow-delay="0.5s">
                            ...
                            <hr class="thin-hr">
                            <h3 class="section-subheading secondary-font">Fresh from the press.</h3>
                        </div>
                    </div>
                </div>
                
                <div class="col-sm-6 col-xs-12 nopadding-lr hover-item">
                    <img src="home/assets/img/news/1.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                    <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                        <div class="vertical-center smoothie">
                            <strong class="heading-font">Travel</strong>
                            <h3><a href="single-post.html" title="view project">Post Title</a></h3>
                            <hr class="thin-hr">
                            <p class="secondary-font post-excerpt">At an these still no dried folly stood thing. Rapid it on hours hills it seven years.</p>
                        </div>
                    </div>
                    <div class="hover-item-caption smoothie">
                ...
                <div class="col-sm-6 col-xs-12 nopadding-lr hover-item">
                    <img src="home/assets/img/news/2.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                    <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                        <div class="vertical-center smoothie">
                            <strong class="heading-font">Travel</strong>
                            <h3><a href="single-post.html" title="view project">Post Title</a></h3>
                ...
                <ul class="owl-carousel fw-carousel wow fadeIn list-unstyled" data-items="3" data-items-tablet="[768,2]"  data-items-mobile="[479,1]">
                    <li class="nopadding-lr hover-item">
                        <img src="home/assets/img/news/3.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                        <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                            <div class="vertical-center smoothie">
                                <strong class="heading-font">Travel</strong>
                                <h3><a href="single-post.html" title="view project">Post Title</a></h3>
                    ...
                    <li class="nopadding-lr hover-item">
                        <img src="home/assets/img/news/4.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                        <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                            <div class="vertical-center smoothie">
                                <strong class="heading-font">Travel</strong>
                                <h3><a href="single-post.html" title="view project">Post Title</a></h3>
                    ...
                    <li class="nopadding-lr hover-item">
                        <img src="home/assets/img/news/5.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                        <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                            <div class="vertical-center smoothie">
                                <strong class="heading-font">Travel</strong>
                                <h3><a href="single-post.html" title="view project">Post Title</a></h3>
                    ...
                    <li class="nopadding-lr hover-item">
                        <img src="home/assets/img/news/6.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                        <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                            <div class="vertical-center smoothie">
                                <strong class="heading-font">Travel</strong>
                                <h3><a href="single-post.html" title="view project">Post Title</a></h3>
                    ...
                    <li class="nopadding-lr hover-item">
                        <img src="home/assets/img/news/7.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                        <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                            <div class="vertical-center smoothie">
                                <strong class="heading-font">Travel</strong>
                                <h3><a href="single-post.html" title="view project">Post Title</a></h3>
                    ...
                    <li class="nopadding-lr hover-item">
                        <img src="home/assets/img/news/8.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                        <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                            <div class="vertical-center smoothie">
                                <strong class="heading-font">Travel</strong>
                                <h3><a href="single-post.html" title="view project">Post Title</a></h3>
                    ...
                    <li class="nopadding-lr hover-item">
                        <img src="home/assets/img/news/9.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                        <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                            <div class="vertical-center smoothie">
                                <strong class="heading-font">Travel</strong>
                                <h3><a href="single-post.html" title="view project">Post Title</a></h3>
                    ...
                    <li class="nopadding-lr hover-item">
                        <img src="home/assets/img/news/10.jpg" class="img-responsive smoothie wow fadeIn" data-wow-delay="0.5s" alt="">
                        <div class="overlay-item-caption smoothie wow fadeIn" data-wow-delay="0.5s">
                            <div class="vertical-center smoothie">
                                <strong class="heading-font">Travel</strong>
                                <h3><a href="single-post.html" title="view project">Post Title</a></h3>
    	...
    	<div role="tabpanel">
            ...
            <div class="tab-content" id="tabs-collapse">            
                <div role="tabpanel" class="tab-pane fade in active" id="contact1">
                    <div id="contact-inner" class="nopadding-lr dark-wrapper opaqued background-cover" style="background-image: url('home/assets/img/bg/bg1.jpg');">
    			        <div class="section-inner dark-opaqued">
    			            <div class="container">
    			                <div class="row">
    			                    <div class="col-md-12">
    			                        <div id="message"></div>
    			                        <form method="post" action="sendemail.php" id="contactform" class="main-contact-form wow fadeIn" data-wow-delay="0.5s">
    		        	...
    		        	<div class="col-md-4">
                            <div class="widget">
                              ...
                              <div>
                                <div class="media">
                                  <div class="pull-left">
                                    <img class="widget-img" src="home/assets/img/widget/widget1.jpg" alt="">
                                  </div>
                                ...
                                <div class="media">
                                  <div class="pull-left">
                                    <img class="widget-img" src="home/assets/img/widget/widget2.jpg" alt="">
                                  </div>
                                  <div class="media-body">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-12 text-center wow fadeIn" data-wow-delay="0.5s">
                        <span class="copyright">Copyright 2019. Designed by DISTINCTIVE THEMES - More Templates <a href="http://www.cssmoban.com/" target="_blank" title="模板之家">模板之家</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></span>
                    </div>
                </div>
            </div>
        </footer>
    ...
    $(document).ready(function(){
       'use strict';
        jQuery('#headerwrap').backstretch([
          "home/assets/img/bg/bg1.jpg",
          "home/assets/img/bg/bg2.jpg",
          "home/assets/img/bg/bg3.jpg"
